...
function Footer() {
  return (
    <><div className='w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2'>
      <div className="max-w-[1400px] mx-auto bg-gray-900 text-white px-4 py-8 grid grid-cols-2 lg:grid-cols-6  border-b-2 border-gray-600 ">
        <div>
          <h1 className="font-bold pt-2">Solutions</h1>
          <ul>
